...
## ↩️ forked from [holman/dotfiles](https://github.com/holman/dotfiles)
...
[Fork it](https://github.com/usamasulaiman/dotfiles/fork), remove what you don't
...
```sh
git clone https://github.com/usamasulaiman/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
[open an issue](https://github.com/usamasulaiman/dotfiles/issues) on this repository
